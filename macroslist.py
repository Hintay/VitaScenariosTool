...
MACROS = {
    ...
    'CHCL': {
        '0': {'0': '@condoff', '2': '@red', '3': '@green', '4': '@blue', '5': '@nega', '6': '@monocro', '8': '@sepia'},
        '1': {'0': '@condoffT', '2': '@redT', '3': '@greenT', '4': '@blueT', '5': '@negaT', '6': '@monocroT',
              '8': '@sepiaT'}},
    'CHZB': '@haze_back',
    'CHZS': '@stophaze',
    'CHZN': '@nohaze_next',
    ...
    'SEFF': '@fadese',
    'SNOW': {'0': '@snowuninit', '1': {'800': '@snowinit forevisible=false backvisible=true'}},
...
SPECIAL_PARAMETER = {'target': TARGET, 'page': PAGE, 'rule': RULE, 'pos': POS, 'layer': LAYER, 'nowait': TRUE_FALSE,
                     'type': NOISE_TYPE, 'base': STORAGES, 'method': METHOD, 'mode': MODE, 'route': ROUTE}
