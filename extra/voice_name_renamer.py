...
class ChangeVoiceName:
    ...
    @staticmethod
    def change_name(root_path, file_name, hex_number):
    ...
    # 用于修复前期脚本所导致的问题文件名
    @staticmethod
    def shrine_fix(root_path, file_name):
        if (file_name.startswith('EMA_') and file_name[4] != '_') or (
                file_name.startswith('KUJI') and (file_name[4] != '_' and file_name[4] != 'F')):
